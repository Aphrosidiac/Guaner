  ...
  return (
    <ThemedShell>
      <section className="max-w-3xl mx-auto px-6 py-16">
        <p className="text-xs uppercase tracking-[0.3em] mb-4" style={{ color: t.accent }}>About</p>
        <h1 className="text-4xl sm:text-5xl mb-6 leading-tight" style={heading}>Quality clothing, built to last.</h1>
        ...
        <Link href={`${base}/products`} className="inline-block px-6 py-3 font-semibold" style={{ background: t.accent, color: t.accentText, borderRadius: t.radius, fontFamily: t.displayFont, textTransform: t.upper ? 'uppercase' : 'none' }}>
          Browse the shop
        </Link>
      </section>
    </ThemedShell>
